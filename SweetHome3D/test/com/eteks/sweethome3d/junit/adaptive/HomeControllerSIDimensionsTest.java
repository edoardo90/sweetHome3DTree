 ...
 */
public class HomeControllerSIDimensionsTest extends TestCase {
  ...
  private static class ControllerTest extends HomeController {
    public ControllerTest(Home home, 
     ...
     Wall wall1 = new Wall(0f, 0f, 100, 100, 7.5f, home.getWallHeight());
     home.addWall(wall1);
     
     
     Wall wall2 = new Wall(200f, 100, 100, 0, 7.5f, home.getWallHeight());
     home.addWall(wall2);
