...
public class Level implements Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    result = prime * result + Float.floatToIntBits(this.floorThickness);
    result = prime * result + Float.floatToIntBits(this.height);
    result = prime * result + ((this.name == null)
        ? 0
        : this.name.hashCode());
    result = prime * result + (this.visible
        ? 1231
        : 1237);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (Float.floatToIntBits(this.floorThickness) != Float.floatToIntBits(other.floorThickness)) {
      return false;
    }
